...
public:
  ...
  using SkipListType = SkipListLatencyBufferModel<types::DAPHNE_SUPERCHUNK_STRUCT>;
  using SkipListAcc = SkipListType::ParanoidSkipListTAcc;
  using SkipListSkip = SkipListType::ParanoidSkipListTSkip;
