/**
* @file BufferedFileWriter.hpp Writes data to a file
*
* This is part of the DUNE DAQ , copyright 2021.
* Licensing/copyright details are in the COPYING file that you should have
* received with this code.
*/
#ifndef READOUT_SRC_BUFFEREDFILEWRITER_HPP_
#define READOUT_SRC_BUFFEREDFILEWRITER_HPP_
...
namespace dunedaq {
  namespace readout {
    ...
    public:
      ...
      BufferedFileWriter(const BufferedFileWriter&)
      = delete; ///< BufferedFileWriter is not copy-constructible
      BufferedFileWriter& operator=(const BufferedFileWriter&)
      = delete; ///< BufferedFileWriter is not copy-assginable
      BufferedFileWriter(BufferedFileWriter&&)
      = delete; ///< BufferedFileWriter is not move-constructible
      BufferedFileWriter& operator=(BufferedFileWriter&&)
      = delete; ///< BufferedFileWriter is not move-assignable
...
#endif // READOUT_SRC_BUFFEREDFILEWRITER_HPP_
