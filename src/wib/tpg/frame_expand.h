...
public:
    ...
    // {
    //     memcpy(m_array, other.m_array, N*sizeof(uint16_t));
    // }
...
// ones. 
RegisterArray<2> expand_segment_collection(const dunedaq::dataformats::ColdataBlock& block);
...
inline RegisterArray<5> get_block_divided_adcs(const dunedaq::dataformats::ColdataBlock& __restrict__ block)
{
...
#pragma GCC diagnostic ignored "-Woverflow"
    ...
    __m256i coll_blend_mask=_mm256_setr_epi16(
        0xffff, 0xffff, 0xffff, 0xffff, // 4 from the second segment, please Carol
        0xffff, 0xffff,                 // 2 don't care
...
#pragma GCC diagnostic pop
    ...
    divided.set_ymm(0, _mm256_permutevar8x32_epi32(_mm256_blendv_epi8(expanded_all[0], expanded_all[1], coll_blend_mask),
                                                         shuffle_mask));
    divided.set_ymm(1, _mm256_permutevar8x32_epi32(_mm256_blendv_epi8(expanded_all[2], expanded_all[3], coll_blend_mask),
                                                         shuffle_mask));
    ...
    const __m256i ind_blend_mask=_mm256_andnot_si256(coll_blend_mask, _mm256_cmpeq_epi8(coll_blend_mask, coll_blend_mask));
    ...
    */
    ...
    divided.set_ymm(4, _mm256_blend_epi32(_mm256_blend_epi32(tmpblend0, tmpblend1, 0xa),
                                          zero,
                                          0xf0));
...
inline FrameRegisters get_frame_divided_adcs(const dunedaq::dataformats::WIBFrame* __restrict__ frame)
{
    ...
    adcs.induction_registers.set_ymm(8, _mm256_blend_epi32(adcs_tmp.ymm(10),
                                                            _mm256_permute4x64_epi64(adcs_tmp.ymm(13), 0x4f),
                                                            0xf0));
    adcs.induction_registers.set_ymm(9, _mm256_blend_epi32(adcs_tmp.ymm(16),
                                                            _mm256_permute4x64_epi64(adcs_tmp.ymm(19), 0x4f),
                                                            0xf0));
...
// register
inline RegisterArray<2> get_block_collection_adcs(const dunedaq::dataformats::ColdataBlock& __restrict__ block)
{
    // First expand all of the channels into `expanded_all`
    __m256i expanded_all[4];
    for(int j=0; j<4; ++j){
...
//==============================================================================
inline RegisterArray<4> get_block_all_adcs(const dunedaq::dataformats::ColdataBlock& __restrict__ block)
{
...
//==============================================================================
//
inline RegisterArray<REGISTERS_PER_FRAME> get_frame_collection_adcs(const dunedaq::dataformats::WIBFrame* __restrict__ frame)
{
...
//==============================================================================
inline RegisterArray<16> get_frame_all_adcs(const dunedaq::dataformats::WIBFrame* __restrict__ frame)
{
...
//======================================================================
inline MessageRegisters expand_message_adcs(const SUPERCHUNK_CHAR_STRUCT& __restrict__ ucs)
{
...
//======================================================================
inline void expand_message_adcs_inplace(const dunedaq::readout::types::WIB_SUPERCHUNK_STRUCT* __restrict__ ucs,
...
// induction registers
// FrameRegisters get_frame_divided_adcs(const dunedaq::dataformats::WIBFrame* __restrict__ frame);
...
// RegisterArray<REGISTERS_PER_FRAME> get_frame_collection_adcs(const dunedaq::dataformats::WIBFrame* __restrict__ frame);

//==============================================================================
// As above, for all collection and induction ADCs
// RegisterArray<16> get_frame_all_adcs(const dunedaq::dataformats::WIBFrame* __restrict__ frame);
