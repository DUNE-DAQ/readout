/**
* @file BufferedFileReader.hpp Reads data to a file
*
...
namespace dunedaq {
  namespace readout {
    ...
    public:
      ...
      = delete; ///< BufferedFileReader is not copy-constructible
      BufferedFileReader& operator=(const BufferedFileReader&)
      = delete; ///< BufferedFileReader is not copy-assginable
      BufferedFileReader(BufferedFileReader&&)
      = delete; ///< BufferedFileReader is not move-constructible
      BufferedFileReader& operator=(BufferedFileReader&&)
      = delete; ///< BufferedFileReader is not move-assignable
