...
public:
  ...
  RandomEngine(const RandomEngine&) = delete;            ///< RandomEngine is not copy-constructible
  RandomEngine& operator=(const RandomEngine&) = delete; ///< RandomEngine is not copy-assginable
  RandomEngine(RandomEngine&&) = delete;                 ///< RandomEngine is not move-constructible
