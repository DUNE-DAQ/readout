...
//==============================================================================
__m256i unpack_one_register(dunedaq::dataformats::WIB2Frame::word_t* first_word)
{
...
RegisterArray<16> unpack(dunedaq::dataformats::WIB2Frame& frame)
{
...
int main(int, char**)
{
    ...
    dunedaq::dataformats::WIB2Frame* frames=new dunedaq::dataformats::WIB2Frame[n_frames];
